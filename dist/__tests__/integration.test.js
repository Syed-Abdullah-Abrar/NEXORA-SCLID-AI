...
describe('Pipeline Integration', () => {
    describe('Full disaster response flow', () => {
        it('SC-1: TaskPlanner decomposes flood query into 3-step graph', async () => {
            const planner = new TaskPlanner_1.TaskPlanner([]);
        ...
        it('SC-2: Resource agent produces supply plan from situational geodata', async () => {
            ...
            const resourceAgent = new ResourceAllocationAgent_1.ResourceAllocationAgent();
        ...
        it('SC-3: Memory persists across agent transitions', async () => {
            const memoryBank = new MemoryBank_1.MemoryBank();
            // Early Warning writes
            const earlyWarningAgent = new EarlyWarningAgent_1.EarlyWarningAgent();
        ...
        it('SC-4: All agent I/O follows registered schema', async () => {
            ...
            const ewa = new EarlyWarningAgent_1.EarlyWarningAgent();
            const saa = new SituationalAwarenessAgent_1.SituationalAwarenessAgent();
            const raa = new ResourceAllocationAgent_1.ResourceAllocationAgent();
        ...
        it('End-to-end: Weather data → Resource plan', async () => {
            const memoryBank = new MemoryBank_1.MemoryBank();
            const earlyWarningAgent = new EarlyWarningAgent_1.EarlyWarningAgent();
            const situationalAgent = new SituationalAwarenessAgent_1.SituationalAwarenessAgent();
            const resourceAgent = new ResourceAllocationAgent_1.ResourceAllocationAgent();
